...
class MultimediaHistoriaService(IMultimediaHistoriaService):
    ...
    async def get_multimedia_historia_by_id_historia(self, id: int) -> Response:
        return await self.multimedia_historia_repository.get_multimedia_historia_by_id_historia(id)
