...
from src.presentation.dto.multimedia_dto import *
from src.presentation.mappers.multimedia_mapper import map_multimedia_domain_to_dto
from src.core.models.multimedia_domain import MultimediaDomain

multimedia_controller = APIRouter(prefix="/api/v1", tags=["multimedia"])


@multimedia_controller.post("/multimedia")
...
@multimedia_controller.get("/multimedia")
...
@multimedia_controller.get("/multimedia/{id}")
...
@multimedia_controller.put("/multimedia/{id}")
...
@multimedia_controller.delete("/multimedia/{id}")
